...
function printMenu(){
    // Imprimir menu
    console.clear()
    let option = parseInt(prompt("Bienvenidos a la Calculadora Insultadora !, por favor ingrese una de las siguientes opciones : \n1 - Suma\n2 - Resta\n3 - Multiplicacion\n4 - Division\n5 - Salir "))
    return option
}
...
function insert(){
    ...
    while (true){
        ...
        console.log("Que parte de NUMERO no entiende IMBECIL ? , intente otra vez ... ")
    }
}
